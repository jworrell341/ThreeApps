...
var lastLat = 0;
var lastLng = 0;
var minimumUpdateTime = 4; //(no more than every x seconds)
var lastTimestamp = 0;
function showAllGeoInfo(APIpositionObject){
    ...
    show("Longitude:  " +
        ...
        " +- " +
        APIpositionObject.coords.accuracy +
        " meters",O("geoInfo"));
    show("Latitude:  " +
        ...
        " meters",O("geoInfo"));
    show("=============================",O("geoInfo"));
    var deltaTime = APIpositionObject.timestamp - lastTimestamp;
    if ( positionChangedEnough() && deltaTime >= 1000*minimumUpdateTime ){
        latestTimestamp = APIpositionObject.timestamp;
...
function showGoogleMap(APIpositionObject){
    ...
    new google.maps.Map(O("map"), googleMapOptions);
}
//====================================DONE=====================================
